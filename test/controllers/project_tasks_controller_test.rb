...
class ProjectTasksControllerTest < ActionController::TestCase
  ...
  test "should create project_task" do
    assert_difference('ProjectTask.count') do
      post :create, project_task: { prio: @project_task.prio, project_id: @project_task.project_id, size: @project_task.size, state: @project_task.state, title: @project_task.title }
    end
  ...
  test "should update project_task" do
    patch :update, id: @project_task, project_task: { prio: @project_task.prio, project_id: @project_task.project_id, size: @project_task.size, state: @project_task.state, title: @project_task.title }
    assert_redirected_to project_task_path(assigns(:project_task))
  end
